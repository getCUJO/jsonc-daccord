                                     ...
                                     json_object *joutput_node)
{
    ...
    json_object *jadditprop_node =
        _jdac_output_create_and_append_node(joutput_node, "additionalProperties");
    ...
    json_object_object_foreach(jobj, jobj_key, jobj_val)
    {
        ...
        json_object *jpatpropkey_node =
            _jdac_output_create_and_append_node(jadditprop_node, jobj_key);
